...
from alkochinczyk_planszowka.constants.view_names import INDEX_VIEW_NAME, NEW_GAME_VIEW_NAME, GAME_DETAIL_VIEW_NAME
from alkochinczyk_planszowka.models import Game
from alkochinczyk_planszowka.views import NewGameView
